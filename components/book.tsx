...
export const ModernBookCover = ({
  ...
  return (
    <div
      className={`z-10 group [perspective:800px] w-min  ${className}`}
    >
      <div
        style={{
...
export const BookTitle = ({ children, className = "" }: BookTitleProps) => (
  <h1
    className={`font-bold select-none mt-3 mb-1 max-w-full break-words text-balance leading-tight text-[clamp(0.95rem,2.2vw,1.25rem)] ${className}`}
  >
    {children}
  </h1>
);
